...
return [
    ...
    'agent_enabled' => (bool) env('AI_AGENT_ENABLED', true),
    'agent_max_iterations' => (int) env('AI_AGENT_MAX_ITERATIONS', 5),
    'agent_max_tool_calls' => (int) env('AI_AGENT_MAX_TOOL_CALLS', 8),
    'agent_execution_mode' => env('AI_AGENT_EXECUTION_MODE', 'autonomous'),

                ...
                <template v-for="[monthNum, monthEvents] in activeMonths" :key="monthNum">
                    <div class="overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm">
                        ...
                        <ul class="divide-y divide-gray-100">
                            <li v-for="ev in monthEvents" :key="ev.id" class="group flex flex-col gap-3 px-4 py-4 hover:bg-gray-50 sm:flex-row sm:items-start sm:gap-4 sm:px-6">
                                ...
                                <div class="min-w-0 flex-1">
                                    ...
                                    <div class="flex min-w-0 items-start gap-2">
                                        ...
                                        <p class="break-words text-sm font-semibold text-gray-900 sm:truncate">

        ...
        if (newChurchId) {
            try {
                ...
                if (clubs.value.length === 0) {
                    ...
                    toast.error('No clubs found for the selected church.')
                } else {
                    clubLoadError.value = false
                }
            } catch (err) {
...
<div class="min-h-screen flex items-center justify-center bg-gray-100 px-4">
    <div class="max-w-md w-full bg-white p-6 rounded shadow">
        <h1 class="text-2xl font-bold mb-4 text-center">Register as a Parent</h1>
        ...
        <form @submit.prevent="submit" class="space-y-4">
            ...
            <div class="mb-4">
                <label for="church_name" class="block text-sm font-medium text-gray-700">Select Church</label>
            ...
            <div class="mb-4">
                <label for="club_id" class="block text-sm font-medium text-gray-700">Select Club</label>

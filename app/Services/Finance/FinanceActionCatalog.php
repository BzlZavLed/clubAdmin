        ...
        return [
            'cashbox' => [
                ...
                'actions' => [
                    ...
                    $this->action('expense.reimbursement_payment_proof_upload', 'Subir comprobante de pago de reembolso', 'Upload reimbursement payment proof', 'club.finance-engine.expenses.reimbursement-payment-proof.upload', 'POST', 'expense', needsTarget: true, writesLedger: false),
                    $this->action('expense.reimbursement_payment_proof_remove', 'Quitar comprobante de pago de reembolso', 'Remove reimbursement payment proof', 'club.finance-engine.expenses.reimbursement-payment-proof.remove', 'DELETE', 'expense', needsTarget: true, writesLedger: false),

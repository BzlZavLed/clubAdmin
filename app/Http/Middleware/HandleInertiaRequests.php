            ...
            'auth' => [
                'user' => fn() => $user
                    ? [
                        ...
                        'parent_activation_method' => $user->parent_activation_method,
                        'password_self_service_enabled' => $user->canSelfServiceCredentials(),
                        'sub_role' => $user->sub_role,
                        'church_id' => $effectiveChurchId ?: $user->church_id,
                        'church_name' => $effectiveChurch?->church_name ?: $user->church_name,
                        'account_church_id' => $user->church_id,
                        'account_church_name' => $user->church?->church_name ?: $user->church_name,
